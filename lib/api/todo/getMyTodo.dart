...
Future<List<Category>> getMyTodo() async {
  try {
    Errordto error = new Errordto();

    final String URL = url+"users/calendar";
    ...
    if (response.statusCode == 200) {
      ...
      List<Category> categories = extractCategories(responseData);
      categories.forEach((category) {
        category.allTodoList.forEach((todo) {
          // print(todo.title);
        });
      });
      return categories;
