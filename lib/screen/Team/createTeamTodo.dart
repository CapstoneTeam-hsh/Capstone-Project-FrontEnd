...
class createTeamTodo extends StatelessWidget {
  final int teamId;
  ...
  const createTeamTodo({Key? key,required this.teamId,this.myTitle,this.myDetail,this.myStart,this.myEnd,this.myLocation,this.myLongitude,this.myLatitude}) : super(key: key);
...
class CreateTodoForm extends StatefulWidget {
  ...
  final double? myLongitude; // 선택적 매개변수로 변경
  final double? myLatitude; // 선택적 매개변수로 변경
  const CreateTodoForm({Key? key,required this.teamId,this.myTitle,this.myDetail,this.myStart,this.myEnd,this.myCP,this.myLocation,this.myLongitude,this.myLatitude}) : super(key: key);
...
class _CreateTodoFormState extends State<CreateTodoForm> {
  ...
  _CreateTodoFormState({required this.teamId,this.myTitle,this.myDetail,this.myStart,this.myEnd,this.myLocation,this.myLongitude,this.myLatitude})
  {
            ...
            children: [
              ...
              IconButton(
                onPressed: () async{
                  ...
                  //print(2);
                  await teamTodoRegi(titleController.text,detailController.text,startDate,endDate,teamId,locationIdResult);
                  //print(3);
